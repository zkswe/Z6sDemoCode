...
static ZKTextView* mCharTextviewPtr;
...
void mainActivity::onCreate() {
    ...
    mCharTextviewPtr = (ZKTextView*)findControlByID(ID_MAIN_CharTextview);
    mNumTextviewPtr = (ZKTextView*)findControlByID(ID_MAIN_NumTextview);
