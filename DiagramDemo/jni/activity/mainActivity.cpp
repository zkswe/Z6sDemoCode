...
static ZKDiagram* mDiagram3Ptr;
static ZKDiagram* mDiagram2Ptr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_ButtonOnOff, onButtonClick_ButtonOnOff,
};
/***************/
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mButtonOnOffPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonOnOff);
    mTextview4Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview4);
    mTextview3Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview3);
    mDiagram3Ptr = (ZKDiagram*)findControlByID(ID_MAIN_Diagram3);
    mDiagram2Ptr = (ZKDiagram*)findControlByID(ID_MAIN_Diagram2);
	onUI_init();
        // 注册监听全局触摸
