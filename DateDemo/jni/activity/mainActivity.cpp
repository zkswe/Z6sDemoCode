...
static ZKEditText* mDayEdittextPtr;
static ZKTextView* mTextview2Ptr;
static ZKEditText* mMonthEdittextPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_SetButton, onButtonClick_SetButton,
};
/***************/
...
static S_EditTextInputCallback SEditTextInputCallbackTab[] = {
    ID_MAIN_DayEdittext, onEditTextChanged_DayEdittext,
    ID_MAIN_MonthEdittext, onEditTextChanged_MonthEdittext,
    ID_MAIN_YearEdittext, onEditTextChanged_YearEdittext,
};
...
void mainActivity::onCreate() {
    ...
    mDayEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_DayEdittext);if(mDayEdittextPtr!= NULL){mDayEdittextPtr->setTextChangeListener(this);}
    mTextview2Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview2);
    mMonthEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_MonthEdittext);if(mMonthEdittextPtr!= NULL){mMonthEdittextPtr->setTextChangeListener(this);}
    mTextview1Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview1);
    mYearEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_YearEdittext);if(mYearEdittextPtr!= NULL){mYearEdittextPtr->setTextChangeListener(this);}
    ...
    mSetButtonPtr = (ZKButton*)findControlByID(ID_MAIN_SetButton);
	mActivityPtr = this;
	onUI_init();
